...
export default function PdfIcon({ label, handler }: PdfIconProps) {
    return (
        <DesktopIcon label={label} handler={handler}>
            <div className="flex h-16 w-12 flex-col rounded-sm border border-white/40 bg-white/90 text-[10px] font-semibold text-zinc-600 shadow-[0_6px_12px_-6px_rgba(0,0,0,0.6)] transition group-hover:border-white/70">
