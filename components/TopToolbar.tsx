...
export default function TopToolbar() {
    return (
        <div className="relative z-10 mx-auto mt-6 flex flex-col sm:flex-row h-26 sm:h-14 w-full max-w-3xl items-center justify-between rounded-full border-t border-white bg-(--bg-light)/20 px-6 py-2 shadow-lg backdrop-blur-xs">
